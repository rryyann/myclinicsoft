...
<div class="row">
	...
	<div class="col-xs-12 col-sm-5 col-md-5 col-lg-8 text-right">
		<div class="btn-group">
			...
			-->
			<?php if(($this->admin_role_id != $this->role_id) ? $this->Module->has_permission('custom_fields', $this->role_id, 'create',   $this->license_id) : true) { ?>
...
<script type="text/javascript">
	...
	$(".create").click(function (e) {
		...
		e.preventDefault();
			$.ajax({
				url: BASE_URL+'custom_fields/view/-1',
				onError: function () {
		        ...
		        "aoColumnDefs": [
		            ...
		            },
		           {
		                ...
		                "render": function (data, type, row) {
							...
							if(can_update){
								newData += '<a rel="tooltip" data-placement="bottom" data-original-title="<?php echo $this->lang->line('__common_update');?>"  href="'+BASE_URL+'custom_fields/view/'+row['id']+'/" class="bootbox btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>';
							}
